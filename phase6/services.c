...
//    pcb[pid].trapframe_p = (trapframe_t *)&proc_stack[pid][PROC_STACK_SIZE];
    ...
    //MyMemcpy((char*)pcb[pid].trapframe_p, (char*)pcb[run_pid].trapframe_p, sizeof(trapframe_t));

    //pcb[pid].trapframe_p = (trapframe_t*)&proc_stack[run_pid][PROC_STACK_SIZE] + diff;
    ...
    //(int*)pcb[pid].trapframe_p->esp = &pcb[pid].trapframe_p->esp + diff;
    //(int*)pcb[pid].trapframe_p->ebp += diff;
    //(int*)pcb[pid].trapframe_p->esi += diff;
    //(int*)pcb[pid].trapframe_p->edi += diff;
